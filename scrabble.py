#In this project, we will create a program that will calculate the score for a word in Scrabble. 
#The program will take in a word as input and output the equivalent scrabble score for that word.
...
#play_word() - a function that would take in player and a word, and add that word to the list of words
